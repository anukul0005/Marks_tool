...
def import_data():
    ...
    try:
        ...
        if file.filename.endswith('.xlsx'):
            df_new = pd.read_excel(file, dtype=str)  # keep values as strings
...
def statistics():
    ...
    df['Chapter'] = df['Chapter'].astype(str).str.strip().str.title()
